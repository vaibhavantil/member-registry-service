...
public class MembersController {
    ...
    public ResponseEntity<String> start() throws Exception {
        ...
        Long id = retryTemplate.execute(arg -> {
            ...
            do {
                ...
                member = repo.findById(memberId.toString());
    ...
    public ResponseEntity<String> convert(@RequestParam String personalIdentificationNumber,
        ...
        Optional<MemberEntity> member = repo.findBypersonalIdentificationNumber(personalIdentificationNumber);
        if(member.isPresent()) {
            return ResponseEntity.status(HttpStatus.ALREADY_REPORTED).body(member.get().getId());
        }
